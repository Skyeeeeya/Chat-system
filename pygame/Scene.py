...
# -*- coding: utf-8 -*-
"""
Created on Tue May 14 05:33:07 2019
...
class Scene(pygame.sprite.Sprite):
	def __init__(self, WIDTH=640, HEIGHT=500):
		...
		self.HEIGHT = HEIGHT
		self.speed = 5
		self.imgs = ['/Users/wanyiyang/Desktop/pygame/bg1.png', '/Users/wanyiyang/Desktop/pygame/bg2.png', '/Users/wanyiyang/Desktop/pygame/bg3.png']
		self.reset()
	# 不停向左移动
	def move(self):
