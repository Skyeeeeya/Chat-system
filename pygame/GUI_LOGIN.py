...
window = tk.Tk()
window.title("Skye and Jennie's Chat System")
window.geometry("500x500")
 
canvas = tk.Canvas(window, height=300, width=500)
image_file = tk.PhotoImage(file="/Users/wanyiyang/Desktop/pygame/welcome.gif")
...
var_usr_name.set('enter your name')
...
def usr_sign_up():
    ...
    window_sign_up.title("Sign Up Page")
 
    sign_name = tk.StringVar()
    sign_name.set('create a name')
